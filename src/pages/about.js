        ...
        <Container className={classes.servicesHero} maxWidth="false">
          <Grid container spacing={10}>
            <Grid item lg={6} md={6} xs={12}>
              ...
              <Typography variant="subtitle2" align="left">
                ...
                small startups to large global brands. Our team of
                videographers, editors, graphic designers, and web developers
                come together as one cohesive unit to create visually,
                emotionally, and rationally compelling content catered to your
                customers. We first get to know you, the client, to better
                understand the personality of your business. Then we work to
            ...
            <Grid item lg={6} md={6} xs={12}>
              ...
              <Typography variant="subtitle2" align="center">
                ...
                strategy by conveying the purpose, context, and lifestyle of
                your brand or business. Clear and creative photos demonstrate
                the credibility of your business or brand by establishing an
                authentic image of who you are and what you are all about.
                Customers will trust your business because of your authenticity
          ...
          <Grid container spacing={10}>
            <Grid item lg={6} md={6} xs={12}>
              ...
              <Typography variant="subtitle2" align="center">
                A majority of consumers are searching online for information
                that will help them make smarter purchasing decisions. In fact,
